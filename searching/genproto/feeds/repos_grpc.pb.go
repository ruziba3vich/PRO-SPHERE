...
type CategoriesServiceClient interface {
	...
	UpdateFeedCategory(ctx context.Context, in *UpdateFeedCategoryRequest, opts ...grpc.CallOption) (*FeedCategory, error)
...
func (c *categoriesServiceClient) UpdateFeedCategory(ctx context.Context, in *UpdateFeedCategoryRequest, opts ...grpc.CallOption) (*FeedCategory, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FeedCategory)
...
type CategoriesServiceServer interface {
	...
	UpdateFeedCategory(context.Context, *UpdateFeedCategoryRequest) (*FeedCategory, error)
...
func (UnimplementedCategoriesServiceServer) UpdateFeedCategory(context.Context, *UpdateFeedCategoryRequest) (*FeedCategory, error) {
...
func _CategoriesService_UpdateFeedCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateFeedCategoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoriesServiceServer).UpdateFeedCategory(ctx, req.(*UpdateFeedCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
